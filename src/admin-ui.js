...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .settings-grid{display:grid;grid-template-columns:minmax(0,1fr) 260px;gap:14px;align-items:start}
    .settings-card textarea{min-height:112px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;line-height:1.55}
    .settings-help{border:1px solid var(--border);border-radius:12px;background:#141414;padding:12px;color:var(--muted);font-size:12px}
    .settings-help-title{color:var(--text);font-weight:700;margin-bottom:6px}
    .settings-help code{color:#bfdbfe}
      ...
      <div class="settings-card">
        <div class="settings-head">
          <div>
            ...
            <div class="muted">可选配置。留空保存即可关闭。</div>
          </div>
        ...
        <div class="settings-grid">
          <div>
            ...
            <div class="settings-hint">每行一个，支持 IP、IP:端口、代理域名:端口；不要带 http:// 或路径。</div>
